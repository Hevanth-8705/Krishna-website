...
export async function executeVoiceCommand(
  ...
  if (cleanQuery.includes('who created you') || cleanQuery.includes('who built you') || cleanQuery.includes('who is your creator') || cleanQuery.includes('hevanth')) {
    const responseText = "I was designed and created by B. Hevanth Kumar, a futuristic systems architect and software engineer. You can inspect his engineering philosophy, vision, and roadmap in the 'About Creator' section.";

    if (navigate) navigate('/creator');
