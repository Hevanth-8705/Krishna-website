...
import { LayoutDashboard, BrainCircuit, Mic, ShieldAlert, RadioReceiver, BookOpen, User, Hexagon, Sparkles, UserCheck, Eye, Zap } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { name: 'About Creator', path: '/creator', icon: User },
];
